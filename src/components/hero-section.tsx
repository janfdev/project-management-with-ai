            ...
            <main className="overflow-hidden bg-zinc-950 text-white min-h-screen">
                        ...
                        <div className="mx-auto max-w-5xl px-6">
                            <div className="sm:mx-auto lg:mr-auto lg:mt-0 text-center lg:text-left">
                                ...
                                <TextEffect
                                    ...
                                    Stop guessing. Start measuring. Assess performance objectively based on real execution data, powered by AI.
                                </TextEffect>
                ...
                <section className="bg-black py-12 border-t border-zinc-900">
                    <div className="mx-auto max-w-5xl px-6 text-center">
                         <p className="text-zinc-500 text-sm">© 2026 Biznovation. Powered by AI & Real Execution Data.</p>
                    </div>
                </section>
            </main>
        </>
